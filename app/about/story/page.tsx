...
export const metadata: Metadata = {
  title: 'aring — 한 짝의 짝을 찾는 AI 매칭 서비스',
  description:
      ...
      <div className="relative w-full max-w-[440px] bg-white min-h-screen sm:my-6 sm:min-h-[900px] sm:rounded-[36px] sm:shadow-phone lg:max-w-[1200px] lg:my-0 lg:rounded-none lg:shadow-none">
        ...
        <article className="px-5 pt-4 pb-24 lg:px-14 lg:pt-12 lg:pb-20 lg:max-w-[760px] lg:mx-auto">
          ...
          <header className="mb-10 lg:mb-14">
            ...
            <h1 className="text-[26px] lg:text-[34px] font-bold tracking-tight text-aring-ink-900 leading-snug break-keep mb-4 lg:mb-5">
              aring — 한 짝의 짝을 찾는 AI 매칭 서비스
            </h1>
            <p className="text-[15px] lg:text-[17px] leading-[1.85] text-aring-ink-700 break-keep">
              ...
              서비스입니다. 형태·컬러·소재·디테일을 AI가 분석해 같은 짝 또는 비슷한 짝을 가진 사용자와
              연결합니다.
            </p>
          </header>
