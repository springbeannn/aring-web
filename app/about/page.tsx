...
const FAQS: Faq[] = [
  {
    q: 'aring은 무엇인가요?',
    a: 'aring(에이링)은 귀걸이 한 짝을 잃어버렸거나 짝이 맞지 않는 귀걸이를 가진 사람들이 서로 연결될 수 있는 매칭 플랫폼입니다. 남은 한 짝을 사진으로 등록하면 AI가 유사하거나 정확히 맞는 짝을 찾아드립니다.',
  },
  {
        ...
        <div className="px-5 pt-4 pb-24 lg:px-14 lg:pt-12 lg:pb-20 lg:max-w-[820px] lg:mx-auto">
          ...
          <header className="mb-10 lg:mb-14">
            ...
            <p className="text-[15px] lg:text-[17px] leading-relaxed text-aring-ink-500 break-keep">
              aring(에이링)은 한 짝만 남은 귀걸이를 등록하면 AI가 모양·소재·색상·브랜드를 분석해
