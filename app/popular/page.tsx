  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 랭크 뱃지 */}
        <span className="absolute top-2 left-2 inline-flex items-center justify-center min-w-[22px] h-[22px] px-1.5 rounded-pill bg-aring-ink-900 text-white text-[10.5px] font-extrabold">
          {rank}
        </span>
        {/* 조회수 */}
        ...
        <div className="pb-28 lg:pb-12">
          ...
          {loading ? (
            ...
            <div className="px-5 lg:px-8 py-16 text-center">
              ...
              <p className="mt-1 text-[11.5px] text-aring-ink-500">첫 등록자가 되어 보세요</p>
              <Link
                href="/register"
                className="mt-4 inline-flex items-center justify-center px-5 py-2.5 rounded-pill bg-aring-ink-900 text-white text-[13px] font-extrabold"
              >
