...
export default function ButtonGuidePage() {
  ...
  const chipSize = isMobile ? 'px-2 py-1 text-[11px]' : 'px-3 py-1.5 text-[13px]';
      ...
      <div className="max-w-[860px] mx-auto">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 1</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 2</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 3</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 4</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 5</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 6</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[10px] font-extrabold tracking-widest text-aring-ink-300 uppercase mb-1">Type 7</p>
            ...
            <div className="flex flex-wrap gap-5">
              {([
                ...
                <button key={label} className="flex flex-col items-center gap-1.5 active:scale-95 transition">
                  ...
                  <span className={cx('font-medium text-aring-ink-700', isMobile ? 'text-[10px]' : 'text-[11px]')}>{label}</span>
                </button>
              ))}
            </div>
            <p className="text-[10px] text-aring-ink-300 mt-3">첫 번째 = active 상태</p>
