  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] p-6 lg:p-10">
      <div className="max-w-[860px] mx-auto">
        ...
        <p className="text-[13px] lg:text-[14px] text-aring-ink-400 mb-6">7가지 버튼 타입 · PC / MOBILE</p>
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 1</p>
            ...
            <div className="flex flex-wrap items-end gap-6">
              <div className="flex flex-col items-start gap-2">
                <a href="#" className={cx('inline-flex items-center gap-1.5 rounded-pill bg-aring-ink-900 text-white font-bold shadow-cta active:scale-95 transition', isMobile ? 'px-3 py-2 text-[12px]' : 'px-4 py-2.5 text-[13px]')}>+ 한 짝 등록</a>
                <span className="text-[12px] text-aring-ink-300">nav</span>
              </div>
              <div className="flex flex-col items-start gap-2">
                <a href="#" className={cx('inline-flex items-center gap-2 rounded-pill bg-aring-ink-900 text-white font-bold shadow-cta active:scale-[0.98] transition', isMobile ? 'px-4 py-2.5 text-[13px]' : 'px-7 py-3.5 text-[14px]')}>등록하기 →</a>
                <span className="text-[12px] text-aring-ink-300">hero</span>
              </div>
              <div className="flex flex-col items-start gap-2 w-full max-w-[260px]">
                <button className={cx('w-full rounded-pill bg-aring-ink-900 text-white font-bold shadow-cta active:scale-[0.99] transition', isMobile ? 'py-3 text-[13px]' : 'py-3.5 text-[14px]')}>다음 단계로</button>
                <span className="text-[12px] text-aring-ink-300">full-width submit</span>
              </div>
              <div className="flex flex-col items-start gap-2 w-full max-w-[260px]">
                <button disabled className={cx('w-full rounded-pill bg-aring-ink-300 text-white font-bold cursor-not-allowed', isMobile ? 'py-3 text-[13px]' : 'py-3.5 text-[14px]')}>사진을 먼저 올려주세요</button>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 2</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 3</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 4</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 5</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 6</p>
          ...
          <section className="bg-white rounded-[20px] p-7 shadow-sm">
            <p className="text-[12px] font-bold tracking-widest text-aring-ink-300 uppercase mb-1">Type 7</p>
            ...
            <div className="flex flex-wrap gap-5">
              {([
                ...
                <button key={label} className="flex flex-col items-center gap-1.5 active:scale-95 transition">
                  ...
                  <span className={cx('font-semibold text-aring-ink-700', isMobile ? 'text-[12px]' : 'text-[13px]')}>{label}</span>
                </button>
              ))}
            </div>
            <p className="text-[12px] text-aring-ink-300 mt-3">첫 번째 = active 상태</p>
