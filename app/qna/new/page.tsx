...
export default function QnaNewPage() {
  ...
  function handlePickImage(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (f.size > IMAGE_MAX_BYTES) {
      setErrorMsg('이미지 크기는 5MB 이하만 첨부할 수 있어요.');
      e.target.value = '';
      return;
    }
    setErrorMsg('');
        ...
        <div className="pb-28 lg:pb-16">
          ...
          <div className="lg:max-w-[720px] lg:mx-auto lg:w-full">
            <form onSubmit={handleSubmit} className="px-5 lg:px-8 space-y-4">
              ...
              {/* 제목 */}
              <div>
                <label htmlFor="qna-title" className="block text-[13px] lg:text-[14px] font-bold text-aring-ink-700 mb-1.5">제목</label>
                <input
                  id="qna-title"
                  type="text"
                  value={title}
              ...
              {/* 내용 */}
              <div>
                <label htmlFor="qna-content" className="block text-[13px] lg:text-[14px] font-bold text-aring-ink-700 mb-1.5">문의 내용</label>
                <textarea
                  id="qna-content"
                  value={content}
              ...
              {/* 이미지 첨부 */}
              <div>
                <label className="block text-[13px] lg:text-[14px] font-bold text-aring-ink-700 mb-1.5">
