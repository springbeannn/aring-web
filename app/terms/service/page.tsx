    ...
    <main className="min-h-screen flex justify-center bg-white">
      <div className="relative w-full max-w-[440px] bg-white min-h-screen lg:max-w-[1200px]">
        <div className="flex items-center gap-3 px-5 pt-4 pb-3 border-b border-aring-ink-100">
          ...
          <h1 className="text-[20px] font-bold text-aring-ink-900">서비스 이용약관</h1>
        </div>
        <div className="px-5 py-6 lg:max-w-[480px] lg:mx-auto">
          <div className="space-y-6 text-[16px] text-aring-ink-700 leading-relaxed">
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제1조 (목적)</h2>
            ...
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제2조 (정의)</h2>
            ...
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제3조 (약관의 효력 및 변경)</h2>
            ...
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제4조 (서비스 이용)</h2>
            ...
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제5조 (이용자의 의무)</h2>
            ...
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제6조 (책임 제한)</h2>
              <p>이 영역은 약관 내용이 들어가는 영역입니다. 이 영역은 약관 내용이 들어가는 영역입니다. 이 영역은 약관 내용이 들어가는 영역입니다. 이 영역은 약관 내용이 들어가는 영역입니다. 이 영역은 약관 내용이 들어가는 영역입니다.</p>
            </section>
            <section>
              <h2 className="text-[16px] font-bold text-aring-ink-900 mb-2">제7조 (분쟁 해결)</h2>
