    ...
    <div className="flex min-h-screen min-w-[1024px] bg-aring-ink-50">
      ...
      <aside className="w-[240px] shrink-0 bg-white border-r border-aring-ink-100 flex flex-col">
        ...
        <div className="h-16 flex items-center px-6 border-b border-aring-ink-100">
          <div className="flex items-baseline gap-1">
            <span className="text-[24px] font-black tracking-tight text-aring-green leading-none">aring</span>
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={[
                  'flex items-center gap-3 px-6 py-3 text-[16px] transition border-l-2',
                  active
        ...
        <div className="p-4 border-t border-aring-ink-100">
          <button
            ...
            className="w-full text-[15px] lg:text-[15px] font-semibold text-aring-ink-600 hover:text-aring-ink-900 border border-aring-ink-200 rounded-lg py-2 transition"
          >
            로그아웃
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-aring-ink-100 flex items-center justify-between px-8 shrink-0">
          <h1 className="text-[20px] font-bold text-aring-ink-900">{pageTitle(pathname)}</h1>
          <div className="flex items-center gap-2 text-[15px] lg:text-[15px] text-aring-ink-500">
            <span>👤</span>
