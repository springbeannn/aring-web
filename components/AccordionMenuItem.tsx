              ...
              <div className="border-b border-[rgb(243,243,245)] last:border-none" data-active={isActive}>
                        <button
                                ...
                                <span
                                            ...
                                            />
                                <span className={`text-[16px] font-bold transition-colors ${isActive ? 'text-aring-green' : 'text-aring-ink-900'}`}>
                                    {label}
                                </span>
                                <svg
                    ...
                    <div
                            ...
                            <div className="py-[6px]">
                                {items.map((item) => (
                                              <button
                                                                key={item.id}
                                                                className="w-full flex items-center gap-2 pl-11 pr-6 py-[13px] text-[15px] lg:text-[15px] leading-[1.5] font-semibold text-aring-ink-500 hover:text-aring-ink-700 hover:bg-[rgb(243,243,245)] active:bg-[rgb(238,238,242)] transition-colors text-left"
                                                              >
