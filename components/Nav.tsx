...
const IconComments = ({ className = 'w-5 h-5', strokeWidth = 1.8 }: IconProps) =>
    (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M18 9h2a2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1" />
        </svg>svg>
      );
          ...
          <>
                <div className="flex items-center justify-between px-5 lg:px-8 pt-2 lg:pt-5 pb-3.5 lg:pb-5 lg:border-b lg:border-aring-green-line">
                        ...
                        <div className="flex items-center gap-2.5">
                                  ...
                                  <button
                                                onClick={() => console.log('topnav:login')}
                                                aria-label="로그인"
    ...
    const item = (
          ...
          dot?: 'unread' | 'new'
              ...
              return (
                      <Link
                                href={href}
                                className={`text-[12px] lg:text-[13px] font-semibold ${isActive ? 'text-aring-ink-900' : 'text-aring-ink-500'} active:opacity-70`}
                              >
                              <div className="flex flex-col items-center gap-1 py-2 relative">
                                {dot && (
                                            <span
                                                            ...
                                                            style={{
                                                                              background: 'linear-gradient(135deg, rgba(251,200,220,.55), rgba(197,221,240,.55))',
                                                                              filter: 'blur(8px)',
                                                                              zIndex: -1,
                                                            }}
                                                          />
