  ...
  return (
    <section className="mt-7">
      ...
      <div className="px-5 lg:px-8">
        {loading ? (
          <p className="text-center py-6 text-[15px] lg:text-[15px] text-aring-ink-500">
            불러오는 중…
          </p>
        ) : error ? (
          <p className="text-center py-6 text-[15px] lg:text-[15px] text-aring-ink-500">
        ...
        {isEditing ? (
          <div className="mt-2">
            <textarea
              ...
              maxLength={1000}
              autoFocus
              className="w-full px-3 py-2 rounded-tile bg-aring-ink-100 text-[15px] lg:text-[15px] text-aring-ink-900 outline-none resize-none"
            />
            <div className="mt-1.5 flex items-center justify-end gap-2">
              <button
                onClick={onCancelEdit}
                className="text-[15px] lg:text-[15px] leading-[1.5] font-semibold text-aring-ink-500 px-2 py-1"
              >
                취소
              </button>
              <button
          ...
          <p className="mt-1.5 text-[15px] lg:text-[15px] leading-[1.5] leading-relaxed text-aring-ink-900 whitespace-pre-wrap break-words">
            {comment.message}
          </p>
        )}
          ...
          <div className="mt-2 flex items-center gap-3">
            {!isReply && (
              <button
                ...
                className="text-[15px] lg:text-[15px] leading-[1.5] font-semibold text-aring-ink-500 hover:text-aring-ink-900 transition"
              >
