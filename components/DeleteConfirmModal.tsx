...
export function DeleteConfirmModal({ onCancel, onConfirm, isDeleting = false }: {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center" onClick={onCancel}>
      ...
      >
        <h2 className="text-[20px] font-bold text-aring-ink-900 text-center">정말 삭제하시겠어요?</h2>
        <p className="mt-2 text-[15px] lg:text-[15px] leading-[1.5] text-aring-ink-500 text-center leading-relaxed">
        ...
        <div className="mt-6 flex gap-2">
          ...
          <button onClick={onConfirm} disabled={isDeleting}
            className="flex-1 py-3 rounded-pill bg-red-400 text-white text-[15px] lg:text-[15px] font-bold hover:bg-red-500 transition active:scale-95 disabled:opacity-50">
